<footer>
    <div class="footer">
        <p class="bw">© 2019 Luca Cellere | All Rights Reserved | <span class="impressum bw">Impressum</span></p>
    </div>
    <div class="ficontainer">
        ...
        <p class="footer-impressum">
            ...
            Davidstrasse 45<br>
            9000 St.Gallen<br>
            <a href="tel:+41796659829">T +41 71 220 91 83</a><br>
            <a href="mailto:hello@schwizerschlatter.com" target="_top">hello@schwizerschlatter.com</a>
        </p>
    </div>
</footer>
