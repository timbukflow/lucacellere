<section class="headercontainer">
    <h1 class="navinfo opencursor">Luca Cellere</h1>
    <a class="monster opencursor" href="index"><img  src="img/random/luca-cellere-monster<?php echo(mt_rand(1,4)); ?>.svg" width="45px"></a>
</section>
...
<nav class="navinfocontainer closercursor">
    ...
    <div class="navfon">
        <a class="opencursor" href="tel:+41796659829">T +41 79 665 98 29</a><br>
        <a class="opencursor" href="mailto:hallo@lucacellere.ch" target="_top">hallo@lucacellere.ch</a>
    </div>
</nav>
    ...
    <div id="kontakt" data-closer="#kontakt" class="infocontainer closercursor">
        <div class="info">
            <h1>
                ...
                <span><a class="info" href="tel:+41796659829">T +41 79 665 98 29</a></span><br>
                <span><a class="info" href="mailto:hallo@lucacellere.ch" target="_top">hallo@lucacellere.ch</a></span><br>
